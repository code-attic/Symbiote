    ...
    public class ConnectionManager : IConnectionManager
    {
        ...
        protected void OpenConnection()
        {
            try
            {
                ...
                var parameters = _connectionFactory.Parameters;
                parameters.UserName = serverConfiguration.User;
                parameters.Password = serverConfiguration.Password;
                parameters.VirtualHost = serverConfiguration.VirtualHost;
                _connection = _connectionFactory.CreateConnection(protocol, hostName, port);
