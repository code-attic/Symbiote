...
namespace Symbiote.Jackalope.Impl
{
        ...
        IDisposable
    {
        ...
        private static Dictionary<Type, List<IDispatch>> _dispatchers = new Dictionary<Type, List<IDispatch>>();
        ...
        public abstract void Start(string queueName, ManualResetEvent reset);
        ...
        protected virtual List<IDispatch> GetDispatchersForPayload(object payload)
        {
            ...
            if (!_dispatchers.TryGetValue(payloadType, out dispatchers))
            {
                ...
                _dispatchers.Add(payloadType, dispatchers);
            }
            return dispatchers;
        }
