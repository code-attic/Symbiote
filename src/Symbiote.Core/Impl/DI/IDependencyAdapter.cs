...
namespace Symbiote.Core.Impl.DI
{
    ...
    {
        private string _msg = "The Dependency Adapter has not been specified.  This can happen when your code is accessing the IoC container before Assimilate.Core() has been called.\r\n";
