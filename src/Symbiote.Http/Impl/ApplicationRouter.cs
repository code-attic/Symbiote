...
namespace Symbiote.Http.Impl
{
        ...
        IRouteRequest
    {
        ...
        public IRegisterApplication DefineApplication<TApplication>(Predicate<IRequest> route) where TApplication : IApplication
        {
        ...
        public IRegisterApplication DefineApplication(Predicate<IRequest> route, Action<IDictionary<string, object>, Action<string, IDictionary<string, IList<string>>, IEnumerable<object>>, Action<Exception>> application)
        {
        ...
        public IApplication GetApplicationFor(IRequest request)
        {
            ...
            if(route == null)
            {
                throw new MissingApplicationException("No application route existed for request: {0}".AsFormat(request.Uri));
            }
