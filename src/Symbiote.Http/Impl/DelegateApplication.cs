...
namespace Symbiote.Http.Impl
{
    public class DelegateApplication : IApplication
    {
        ...
        public static implicit operator DelegateApplication(Action<IDictionary<string, object>, Action<string, IDictionary<string, IList<string>>, IEnumerable<object>>, Action<Exception>> application)
        {
            return new DelegateApplication(application);
        }

        public DelegateApplication(Action<IDictionary<string, object>, Action<string, IDictionary<string, IList<string>>, IEnumerable<object>>, Action<Exception>> application)
        {
