...
namespace Symbiote.Lucene.Impl
{
    ...
    public class DateTimeFieldType : FieldType
    {
        ...
        {
            return NumericRangeQuery.NewLongRange( name, 8, ToDateTime( min, DateTime.MinValue ),
                                                   ToDateTime( max, DateTime.MaxValue ), inclusive, inclusive );
        }
    ...
    public class DoubleFieldType : FieldType
    {
        ...
        public override Query ToRangeQuery( string name, string min, string max, bool inclusive )
        {
            return NumericRangeQuery.NewDoubleRange( name, 9, ToDouble( min, 0 ), ToDouble( max, Double.MaxValue ),
                                                     inclusive, inclusive );
        }
    ...
    public class FloatFieldType : FieldType
    {
        ...
        public override Query ToRangeQuery( string name, string min, string max, bool inclusive )
        {
            return NumericRangeQuery.NewFloatRange( name, ToFloat( min, 0 ), ToFloat( max, float.MaxValue ), inclusive,
                                                    inclusive );
        }
    ...
    public class IntFieldType : FieldType
    {
        ...
        public override Query ToRangeQuery( string name, string min, string max, bool inclusive )
        {
            return NumericRangeQuery.NewIntRange( name, ToInt( min, 0 ), ToInt( max, int.MaxValue ), inclusive,
                                                  inclusive );
        }
    ...
    public class LongFieldType : FieldType
    {
        ...
        public override Query ToRangeQuery( string name, string min, string max, bool inclusive )
        {
            return NumericRangeQuery.NewLongRange( name, ToLong( min, 0 ), ToLong( max, long.MaxValue ), inclusive,
                                                   inclusive );
        }
