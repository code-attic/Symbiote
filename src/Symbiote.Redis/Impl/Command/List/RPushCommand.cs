...
namespace Symbiote.Redis.Impl.Command.List
{
        ...
        : RedisCommand<bool>
    {
        ...
        public bool RPush( IConnection connection )
        {
            ...
            return connection.SendExpectSuccess( data, RPUSH.AsFormat( Key.Length, Key, data.Length ) );
        }

        public RPushCommand( string key, TValue value )
        {
            Key = key;
            Value = value;
            Command = RPush;
