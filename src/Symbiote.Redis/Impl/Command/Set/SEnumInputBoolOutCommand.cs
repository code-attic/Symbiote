...
namespace Symbiote.Redis.Impl.Command.Set
{
        ...
        : RedisCommand<bool>
    {
        ...
        public bool GetEnum(IRedisConnection connection)
        {
            SetCmd();
            ...
            return connection.SendExpectSuccess(stream.ToArray(), HEADER.AsFormat(Key.Count() + 2, CMD.Length, CMD, DestKey.Length, DestKey));
        }
