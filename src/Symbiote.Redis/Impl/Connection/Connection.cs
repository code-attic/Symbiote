...
namespace Symbiote.Redis.Impl.Connection
{
        ...
        : IConnection
    {
        ...
        //TODO: Clean up this call and refactor
        ...
        protected IDictionary<string, byte[]> ReadDataDict()
        {
            ...
            if ( sentinel == '$' )
            {
                throw new ResponseException(
                    "Invalid return data; unable to convert single value to IDictionary<string, T>" );
            }
            ...
            if ( sentinel == '*' )
            {
                ...
                if ( Int32.TryParse( line.Substring( 1 ), out replyCount ) )
                {
                    ...
                    else
                    {
                        ...
                        if ( remainder != 0 )
                            throw new ResponseException(
                                "Invalid return data; unable to convert an odd number of returns to IDictionary<string, T>" );
