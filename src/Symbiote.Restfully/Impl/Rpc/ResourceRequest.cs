...
namespace Symbiote.Restfully.Impl.Rpc
{
    ...
    {
        protected IHttpServiceHostConfiguration Configuration { get; set; }
        ...
        public ResourceRequest(HttpListenerContext context, IHttpServiceHostConfiguration configuration)
        {
        ...
        public ResourceRequest(HttpContext context, IHttpServiceHostConfiguration configuration)
        {
            Context = new HttpContextAdapter(context);
            Configuration = configuration;
            Initialize();
