    ...
    public class RiakSerializer
    {
        public Dictionary<Type, RequestCode> CommandCodes = new Dictionary<Type, RequestCode>
                                                                {
                                                                    ...
                                                                    {
                                                                        typeof( GetBucketProperties ),
                                                                        RequestCode.GetBucketProperties
                                                                        },
                                                                    {
                                                                        typeof( SetBucketProperties ),
                                                                        RequestCode.SetBucketProperties
                                                                        },
        ...
        public object GetResult( NetworkStream stream )
        {
            ...
            if ( bytes.Length > 4 )
            {
                ...
                result = messageBytes.Length == 0
                           ? Activator.CreateInstance( messageType )
                           : messageBytes.FromProtocolBuffer( messageType );
            }
            return result;
        }
    }
