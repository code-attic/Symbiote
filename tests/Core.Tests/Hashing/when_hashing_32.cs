...
{
    public class when_hashing_32 : with_substantial_keyset
    {
        private Because of = () => 
                                 {
        ...
        private It should_be_quick = () => Elasped.ShouldBeLessThanOrEqualTo( 30 );
