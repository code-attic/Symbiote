...
namespace Couch.Tests.Caching
{
    public class when_getting_cache_keys_with_default_cache_key_builder
    {
        ...
        protected static string expected_id_key = "Couch.Tests.TestDocument_1";
        protected static string expected_id_and_rev_key = "Couch.Tests.TestDocument_1_B";
        protected static string expected_list_key = "Couch.Tests.TestDocument_list";
        protected static string expected_paged_list_key = "Couch.Tests.TestDocument_1_10";
        protected static string expected_range_key = "Couch.Tests.TestDocument_[\"A\",1]_[\"C\",4]";
        protected static string expected_object_key = "Couch.Tests.TestDocument_{\"property\":\"value\"}";
