...
namespace Mikado.Tests
{
    ...
    public class when_testing_all_broken_rules_on_a_Person_in_a_Mikado_Context : with_Person
    {
        ...
        private It should_have_reverted_the_Address_to_123_Anywhere_St = () => Person.Addresses[0].Address.ShouldEqual("123 Anywhere St.");
        private It should_have_reverted_the_City_to_Nashvegas = () => Person.Addresses[0].City.ShouldEqual("Nashvegas");
        private It should_have_reverted_the_State_to_TN = () => Person.Addresses[0].State.ShouldEqual("TN");
        private It should_have_reverted_the_ZipCode_to_12345 = () => Person.Addresses[0].ZipCode.ShouldEqual("12345");
    ...
    public class when_testing_Address_broken_rule_on_a_Person_in_a_Mikado_Context : with_Person
    {
        public static TestSubscriber Subscriber = new TestSubscriber();
    ...
    public class when_testing_City_broken_rule_on_a_Person_in_a_Mikado_Context : with_Person
    {
        public static TestSubscriber Subscriber = new TestSubscriber();
    ...
    public class when_testing_State_broken_rule_on_a_Person_in_a_Mikado_Context : with_Person
    {
        public static TestSubscriber Subscriber = new TestSubscriber();
    ...
    public class when_testing_ZipCode_broken_rule_on_a_Person_in_a_Mikado_Context : with_Person
    {
        public static TestSubscriber Subscriber = new TestSubscriber();
