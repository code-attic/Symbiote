...
namespace Relax.Tests.Configuration
{
    ...
    public class when_using_caching_with_no_expiration : with_couch_configuration
    {
        ...
        private It should_not_expire = () => configuration.CacheExpiration.ShouldEqual(DateTime.MaxValue);
    }
}